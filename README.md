...
The raw data used in this analysis was sourced from Kaggle’s Shoe Prices dataset. It includes detailed transaction data for various footwear products. You can download the dataset using the link below:
[(link: Kaggle Dataset](https://www.kaggle.com/datasets/rkiattisak/shoe-prices-dataset/code?datasetId=3000086))
